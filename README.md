...
- **[Python 3.x** must be installed on the computer that will be used to generate YAML files, and the **[csv-to-yml.py](https://github.com/ries07uw/HathiTrustYAMLgenerator/blob/master/MODIFIED_yaml_csv.py)** script will need to be downloaded as well.  
